package com.dabangvr.mall.adapter;
...
public class CartAdapter extends BaseExpandableListAdapter {
    ...
    public CartAdapter(Context context, String token, LinearLayout llSelectAll,
    ...
    private void getDateFromHttpCart(String ids) {
        ...
        map.put("cartIds", ids);
        OkHttp3Utils.getInstance(MyApplication.getInstance()).doPostJson(DyUrl.confirmGoods2Cart, map, new ObjectCallback<String>(MyApplication.getInstance()) {
            @Override
            public void onUi(String result) throws JSONException {
                // TODO: 2019/10/21 跳转到订单确认界面
                sendServerCallback.hide();
            }
