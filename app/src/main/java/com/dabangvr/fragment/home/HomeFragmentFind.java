...
public class HomeFragmentFind extends BaseFragment {
    ...
    public void initView() {
        ...
        HomeFindMo homeFindMo = new HomeFindMo(4, R.layout.item_home_find_one);
        ...
        adapter = new MoreItemAdapter<HomeFindMo>(getContext(), mData) {
            ...
            public void convert(BaseRecyclerHolder holder, int position, HomeFindMo s) {
                ...
                if (s.getmType() == 2) {
                    ...
                    RecyclerAdapterTest adapter = new RecyclerAdapterTest<String>(getContext(), s.getmResources(), R.layout.item_conver_match) {
                        @Override
                ...
                if (s.getmType() == 4) {
                    ...
                    RecyclerAdapter adapter = new RecyclerAdapter<HomeFindMo.TypeMo>(getContext(), s.getmTypeMo(), R.layout.item_type) {
                        @Override
