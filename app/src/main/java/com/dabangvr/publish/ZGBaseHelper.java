...
public class ZGBaseHelper {
     ...
     */
    public void setSDKContextEx(final String logPath, final String soFullPath, final long logFileSize, final Application application) {
