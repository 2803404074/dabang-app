...
import com.tencent.liteav.demo.edit.view.SampleProgressButton;
import com.tencent.liteav.demo.edit.view.TCBGMInfo;
...
public class TCMusicAdapter extends BaseRecyclerAdapter<TCMusicAdapter.LinearMusicViewHolder> implements View.OnClickListener {
    ...
    public LinearMusicViewHolder onCreateVH(ViewGroup parent, int viewType) {
        LinearMusicViewHolder linearMusicViewHolder = new LinearMusicViewHolder(View.inflate(parent.getContext(), R.layout.item_editer_bgms, null));
