...
import com.tencent.liteav.demo.edit.util.TCMotionViewInfoManager;
import com.tencent.liteav.demo.edit.util.TCPasterViewInfoManager;
import com.tencent.liteav.demo.edit.util.TCTimeViewInfoManager;
import com.tencent.liteav.demo.edit.util.TCUserMgr;
import com.tencent.liteav.demo.edit.view.ActionSheetDialog;
import com.tencent.liteav.demo.edit.view.TCStaticFilterViewInfoManager;
...
//            EventBus.getDefault().post(TCConstants.EVENT_MSG_SAVE_DONE);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.editer_back_ll) {// 返回
            back();
        } else if (id == R.id.btn_complete) {// 开始生成
            showPublishDialog();
            ...
            startActivityForResult(intent, TCConstants.ACTIVITY_OTHER_REQUEST_CODE);
        } else if (id == R.id.layout_publish_success) {
...
//                        clearConfig();
    ...
    private void addTailWaterMark() {
        ...
        Bitmap tailWaterMarkBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.application);
