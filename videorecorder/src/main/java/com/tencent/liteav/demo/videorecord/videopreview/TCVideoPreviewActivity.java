...
public class TCVideoPreviewActivity extends Activity implements View.OnClickListener, ITXVodPlayListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tvGo).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TCVideoPreviewActivity.this, TCVideoPublishActivity.class);
                intent.putExtra(com.tencent.liteav.demo.videouploader.common.utils.TCConstants.VIDEO_EDITER_PATH,mVideoPath);
