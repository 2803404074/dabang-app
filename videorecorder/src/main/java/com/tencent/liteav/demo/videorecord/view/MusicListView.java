...
import com.tencent.liteav.demo.videorecord.mybottom.MediaEntity;
...
public class MusicListView extends ListView {
    ...
    public void setupList(LayoutInflater inflater, List<MediaEntity> data){
        mData = data;
...
class MusicListAdapter extends BaseAdapter{
    ...
    MusicListAdapter(LayoutInflater inflater, List<MediaEntity> list){
        mInflater = inflater;
        mData = list;
    }
    @Override
