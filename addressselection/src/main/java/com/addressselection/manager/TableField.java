...
public class TableField {
    ...
    public static final String ADDRESS_DICT_FIELD_CENTER = "center";//经纬度

    //创建地址库字典表sql语句
    public static final String CREATE_ADDRESS_DICT_SQL = "create table " + TABLE_ADDRESS_DICT +
            "("+ ADDRESS_DICT_FIELD_ID + " integer not null," +  ADDRESS_DICT_FIELD_PARENTID + " integer not null,"
            + ADDRESS_DICT_FIELD_CODE + " text," + ADDRESS_DICT_FIELD_CENTER + " text,"+ ADDRESS_DICT_FIELD_NAME + " text)";
}
